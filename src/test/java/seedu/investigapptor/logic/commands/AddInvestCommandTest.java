...
public class AddInvestCommandTest {
    ...
    public void execute_personAcceptedByModel_addSuccessful() throws Exception {
        ...
        assertEquals(String.format(AddInvestCommand.MESSAGE_SUCCESS, validPerson), commandResult.feedbackToUser);
    ...
    public void execute_duplicatePerson_throwsCommandException() throws Exception {
        ...
        thrown.expectMessage(AddInvestCommand.MESSAGE_DUPLICATE_PERSON);
    ...
    public void equals() {
        ...
        AddInvestCommand addAliceCommand = new AddInvestCommand(alice);
        AddInvestCommand addBobCommand = new AddInvestCommand(bob);

        // same object -> returns true
        assertTrue(addAliceCommand.equals(addAliceCommand));

        // same values -> returns true
        AddInvestCommand addAliceCommandCopy = new AddInvestCommand(alice);
    ...
    /**
     * Generates a new AddInvestCommand with the details of the given person.
     */
    private AddInvestCommand getAddCommandForPerson(Person person, Model model) {
